...
GpuHeightFieldWater.prototype.__setupShaders = function () {
    ...
    THREE.ShaderManager.addShader('/passUv.vert');

    THREE.ShaderManager.addShader('/hfWater_disturb.frag');
    this.disturbAndSourceMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_disturb.frag')
    });
    ...
    THREE.ShaderManager.addShader('/setColor.frag');
    this.resetMaterial = new THREE.ShaderMaterial({
        uniforms: {
            uColor: { type: 'v4', value: new THREE.Vector4() }
        },
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/setColor.frag')
    });

    THREE.ShaderManager.addShader('/setColorMasked.frag');
    this.resetMaskedMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/setColorMasked.frag')
    });

    THREE.ShaderManager.addShader('/setSolidAlpha.frag');
    this.setSolidAlphaMaterial = new THREE.ShaderMaterial({
        uniforms: {
            uTexture: { type: 't', value: this.emptyTexture }
        },
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/setSolidAlpha.frag')
    });

    THREE.ShaderManager.addShader('/hfWater_obstacles_static.frag');
    this.staticObstaclesMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_obstacles_static.frag')
    });

    THREE.ShaderManager.addShader('/hfWater_obstacles_dynamic.frag');
    this.dynObstaclesMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_obstacles_dynamic.frag')
    });

    THREE.ShaderManager.addShader('/encodeFloat.frag');
    this.rttEncodeFloatMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/encodeFloat.frag')
    });

    THREE.ShaderManager.addShader('/copyChannels.frag');
    this.copyChannelsMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/copyChannels.frag')
    });

    THREE.ShaderManager.addShader('/hfWater_calcDisturbMap.frag');
    this.calcDisturbMapMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_calcDisturbMap.frag')
    });

    THREE.ShaderManager.addShader('/gaussianBlurX.frag');
    this.gaussianBlurXMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/gaussianBlurX.frag')
    });

    THREE.ShaderManager.addShader('/gaussianBlurY.frag');
    this.gaussianBlurYMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/gaussianBlurY.frag')
    });

    THREE.ShaderManager.addShader('/combineTextures.frag');
    this.combineTexturesMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/combineTextures.frag')
    });

    THREE.ShaderManager.addShader('/erode.frag');
    this.erodeMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/erode.frag')
    });
...
GpuHeightFieldWater.prototype.__setupObstaclesScene = function () {
    ...
    THREE.ShaderManager.addShader('/pass.vert');
    THREE.ShaderManager.addShader('/depth.frag');
    this.rttObstaclesDepthMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/pass.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/depth.frag')
    });

    //create material for masking out water texture
    THREE.ShaderManager.addShader('/combineTexturesMask.frag');
    this.maskWaterMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/combineTexturesMask.frag')
    });
};
...
GpuMuellerGdc2008Water.prototype.getWaterFragmentShaderUrl = function () {
    return '/hfWater_muellerGdc2008.frag';
};
...
GpuMuellerGdc2008HwWater.prototype.getWaterFragmentShaderUrl = function () {
    return '/hfWater_muellerGdc2008Hw.frag';
};
...
GpuTessendorfIWaveWater.prototype.getWaterFragmentShaderUrl = function () {
    return '/hfWater_tessendorfIWave.frag';
};
GpuTessendorfIWaveWater.prototype.__setupShaders = function () {

    GpuHeightFieldWater.prototype.__setupShaders.call(this);

    THREE.ShaderManager.addShader('/hfWater_tessendorfIWave_convolve.frag');
    this.convolveMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_tessendorfIWave_convolve.frag')
    });
...
GpuPipeModelWater.prototype.getWaterFragmentShaderUrl = function () {
    return '/hfWater_pipeModel.frag';
};
GpuPipeModelWater.prototype.__setupShaders = function () {

    GpuHeightFieldWater.prototype.__setupShaders.call(this);

    THREE.ShaderManager.addShader('/hfWater_pipeModel_calcFlux.frag');
    this.waterSimMaterial = new THREE.ShaderMaterial({
        uniforms: {
            uTerrainTexture: { type: 't', value: this.emptyTexture },
            uWaterTexture: { type: 't', value: this.emptyTexture },
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/hfWater_pipeModel_calcFlux.frag')
    });
    ...
    THREE.ShaderManager.addShader('/calcFinalWaterHeight.frag');
    this.calcFinalWaterHeightMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/calcFinalWaterHeight.frag')
    });
