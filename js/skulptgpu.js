...
GpuSkulpt.prototype.__setupShaders = function () {
    ...
    THREE.ShaderManager.addShader('/skulpt.frag');
    this.skulptMaterial = new THREE.ShaderMaterial({
        ...
        fragmentShader: THREE.ShaderManager.getShaderContents('/skulpt.frag')
    });
    ...
    THREE.ShaderManager.addShader('/scaleAndFlipV.frag');
    this.rttProxyMaterial = new THREE.ShaderMaterial({
        ...
        vertexShader: THREE.ShaderManager.getShaderContents('/passUv.vert'),
        fragmentShader: THREE.ShaderManager.getShaderContents('/scaleAndFlipV.frag')
    });
